...
int GLLimite = 3000;      //valore predefinito 3kW.
...
boolean GBPrimaNotifica = true; //serve a indicare che non è stata ancora inviata nessuna notifica tramite Pushetta 
  ...
  void sendToPushetta(){
                 ...
                 {                                     
                   client << F("POST /api/pushes/") << F("CHANNEL"); // inserire il proprio channel
                   client << F("/ HTTP/1.1\n");
